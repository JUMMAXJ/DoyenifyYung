...
describe('Yung Doyen Signup',() => {
  ...
  it.only('To register a new user account on Doyenify Academy YungDoyens', () => {
     ...
     cy.get('[style="background-color: rgb(254, 90, 29); padding: 8px; color: rgb(255, 255, 255); border-radius: 30px; cursor: pointer;"] > div').click();
     //const specificDate = new Date('2 1 2015'); // February 1, 2015 (month is 0-indexed)
     //cy.log(specificDate.toDateString()); // Logs: Sun Feb 01 2015
     //cy.get('[style="background-color: rgb(254, 90, 29); padding: 8px; color: rgb(255, 255, 255); border-radius: 30px; cursor: pointer;"] > div').click();
     //cy.get(':nth-child(1) > :nth-child(1) > [style="margin-top: 5%;"] > div > h1 > span').click();
     //cy.get('#Email').type(Email);
